      ...
      "children": [
        {
          ...
          "name": "ChatDashboard",
          "file": {
            "path": "src/routes/chat/ChatDashboard.svelte",
            "dir": "src/routes/chat",
            "base": "ChatDashboard.svelte",
            "ext": ".svelte",
            "name": "ChatDashboard"
          },
          "asyncModule": () => import('../src/routes/chat/ChatDashboard.svelte'),
          "children": []
        },
        {
          "meta": {},
        ...
        {
          "meta": {},
          "id": "_default_chat_ChatThumb_svelte",
          "_regex": {},
          "_paramKeys": {},
          "name": "ChatThumb",
          "file": {
            "path": "src/routes/chat/ChatThumb.svelte",
            "dir": "src/routes/chat",
            "base": "ChatThumb.svelte",
            "ext": ".svelte",
            "name": "ChatThumb"
          },
          "asyncModule": () => import('../src/routes/chat/ChatThumb.svelte'),
          "children": []
        },
        {
          "meta": {},
          ...
          "name": "Message",
          "file": {
            "path": "src/routes/chat/Message.svelte",
            "dir": "src/routes/chat",
            "base": "Message.svelte",
            "ext": ".svelte",
            "name": "Message"
          },
          "asyncModule": () => import('../src/routes/chat/Message.svelte'),
          "children": []
        },
        {
          "meta": {},
          "id": "_default_chat_NewChat_svelte",
          "_regex": {},
          "_paramKeys": {},
          "name": "NewChat",
          "file": {
            "path": "src/routes/chat/NewChat.svelte",
            "dir": "src/routes/chat",
            "base": "NewChat.svelte",
            "ext": ".svelte",
            "name": "NewChat"
          },
          "asyncModule": () => import('../src/routes/chat/NewChat.svelte'),
          "children": []
        },
        {
          "meta": {
